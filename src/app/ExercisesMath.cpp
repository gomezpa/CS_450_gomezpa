...
int main(int argc, char **argv) {
    ...
    cout << "Begin Mathematical adventure" << endl;
    glm::vec3 A(1,4,0);
    ...
    try {
        string vertCode = readFileToString("./shaders/ExercisesMath/Basic.vs");
        string fragCode = readFileToString("./shaders/ExercisesMath/Basic.fs");
