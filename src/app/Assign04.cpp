...
glm::mat4 makeRotateZ(glm::vec3 offest){
	float rad = glm::radians(rotAngle);

	glm::mat4 negTranslation = glm::translate(glm::mat4(1.0f), -offest);
	glm::mat4 rotate = glm::rotate(glm::mat4(1.0f), rad, glm::vec3(0.0f, 0.0f, 1.0f));
	glm::mat4 posTranslation = glm::translate(glm::mat4(1.0f), offest);
